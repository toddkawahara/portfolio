...
- Utilized Causal Inference techniques to estimate the effect a playoff game has on pitcher game performance
...
- Controlled for pitcher ability, opponent lineup strength, and home games to fit model on pitcher's FIP in a game
- Utilized non-centered parameterization for more efficient random effect sampling
- Examined global and invididual playoff game slope posteriors to determine there is no effect on performance 
